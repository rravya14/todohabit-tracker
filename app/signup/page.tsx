      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-center">
            Create an account to manage your tasks and habits
          </p>
        </div>

        <Card className="border-violet-200 dark:border-violet-800 shadow-md dark:bg-gray-800">
          <CardHeader>
            <CardTitle className="text-2xl text-center text-violet-900 dark:text-violet-300">Sign Up</CardTitle>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-violet-800 dark:text-violet-300">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-violet-400" />
